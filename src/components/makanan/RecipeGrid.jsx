...
export default function RecipeGrid({ recipes, onRecipeClick, favorites, onToggleFavorite }) {
          ...
          >
            ...
            >
              ...
              <div className="relative h-32 md:h-56 overflow-hidden">
                ...
                >
                  <Heart className={`w-4 h-4 ${favorites && favorites.includes(recipe.id) ? 'text-red-500 fill-current' : 'text-slate-400'}`} />
                </button>
              </div>
